...
df1 =df[(df.iloc[:, 0].astype(str).str.startswith('C'))] # 
...
df2 = df1[(df1.iloc[:, 0].astype(str).str.startswith('5UZF_min'))]
...
feature_names = ['rad', 'CN', 'q', 'hbond'] + list(df3.columns[df3.columns.str.startswith('name') | df3.columns.str.startswith('resname') | df3.columns.str.startswith('neighbor_resnames_0_') | df3.columns.str.startswith('neighbor_resnames_1_') | df3.columns.str.startswith('neighbor_names_0_') | df3.columns.str.startswith('neighbor_names_1_') | df3.columns.str.startswith('neighbor_names_2_') | df3.columns.str.startswith('neighbor_names_3_')]) 

feature_names_test = ['rad', 'CN', 'q', 'hbond'] + list(df2.columns[df2.columns.str.startswith('name') | df2.columns.str.startswith('resname') | df2.columns.str.startswith('neighbor_resnames_0_') | df2.columns.str.startswith('neighbor_resnames_1_') | df2.columns.str.startswith('neighbor_names_0_') | df2.columns.str.startswith('neighbor_names_1_') | df2.columns.str.startswith('neighbor_names_2_') | df2.columns.str.startswith('neighbor_names_3_')])
...
np.savetxt('X_test_C.csv', X_test, delimiter=',', header=','.join(feature_names), comments='')
...
np.savetxt('y_test_pred_C.csv', y_test, delimiter=',', header=','.join(feature_names), comments='')
